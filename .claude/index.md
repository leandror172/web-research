...
| `spike/.memories/QUICK.md` | Per-folder working memory — current state, key facts, pointers |
| `spike/.memories/KNOWLEDGE.md` | Per-folder semantic memory — accumulated findings, rankings, architecture |
